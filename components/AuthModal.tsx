...
export const AuthModal: React.FC<AuthModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative bg-mosport-card border border-gray-800 w-full max-w-md rounded-2xl p-8 shadow-2xl">
        ...
        <div className="space-y-4">
          ...
          <Button fullWidth variant="primary" className="py-3 mt-4">
            Let's go Team!
          </Button>
          ...
          <div className="grid grid-cols-4 gap-2">
             <button className="flex items-center justify-center p-3 bg-gray-800 hover:bg-gray-700 rounded-lg transition-colors text-white">
                {/* Fake IG Icon */}
             ...
             <button className="flex items-center justify-center p-3 bg-blue-500 hover:bg-blue-600 rounded-lg transition-colors text-white font-bold text-xs">
               Zalo
             </button>
          </div>
          
          <div className="text-center mt-6">
            <button className="text-xs text-gray-500 hover:text-white flex items-center justify-center w-full gap-1">
